...
# Args
# -----------------------------
parser = argparse.ArgumentParser(description="Extract pose keypoints from video using MMPose (squat - full body tracking)")
...
MIN_COMPLETENESS = 0.50  # fraction of joints present to trust a pose
