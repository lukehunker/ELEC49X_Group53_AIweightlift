...
parser.add_argument("--device", default="cuda:0", help="Device to run inference on (e.g. cuda:0 or cpu)")parser.add_argument("--sample-fps", type=float, default=10.0, help="Sample rate for processing (default: 10 fps, 0 = process all frames)")args = parser.parse_args()
